"""
Django settings for cold_union_dev_102554 project.
...
ROOT_URLCONF = 'cold_union_dev_102554.urls'
...
WSGI_APPLICATION = 'cold_union_dev_102554.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_union_dev_102554 API",
    "DESCRIPTION": "API documentation for cold_union_dev_102554 App",
    "VERSION": "v1",
}
